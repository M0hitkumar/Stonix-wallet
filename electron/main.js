...
async function createWindow () {
  ...
  const stonixServer = await control.maybeStart()
    .catch(err => console.error('Stonix server failed', err.stack || err))
  ...
  if (stonixServer) {
    ...
    await mainWindow.webContents.executeJavaScript('localStorage.serverInfo = '+JSON.stringify(JSON.stringify(stonixServer)))
  }
