...
if (!process.env.NO_COOKIE_FILE && !process.env.COOKIE_FILE)
  process.env.COOKIE_FILE = path.join(os.homedir(), '.stonix-wallet', 'cookie')

process.env.NODE_ENV || (process.env.NODE_ENV = 'production')
process.env.VERBOSE && (process.env.DEBUG = `clightning-client,stonix,superagent,${process.env.DEBUG||''}`)
